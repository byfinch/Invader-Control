  ...
  async function go(page){
    try{
      ...
      tbody.innerHTML=d.rows.map(function(row){
        return '<tr><td class="time">'+esc(row.ts)+'</td><td><span class="site-url">'+esc(row.site)+'</span></td><td>'+row.status+'</td><td>'+row.ustatus+'</td><td class="http">'+esc(row.http)+'</td><td class="expect">'+esc(row.alt)+'</td><td class="note" title="'+esc(row.note_title||'')+'"><div class="clamp">'+(row.note_html||'-')+'</div></td></tr>';
