...
.summary{display:grid;grid-template-columns:1.6fr 1fr 1fr 1fr;margin-bottom:30px;border:1px solid transparent;background:linear-gradient(var(--paper),var(--paper)) padding-box,linear-gradient(135deg,rgba(57,255,106,.45),#12301c 60%) border-box;clip-path:var(--chamfer-lg)}.metric{min-height:104px;padding:18px 22px;border-right:1px solid var(--line)}.metric:last-child{border-right:0}.metric-label{display:block;color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.8px}.metric-value{display:block;margin-top:11px;font-size:28px;font-weight:500;font-family:var(--head-font)}.metric-value.good{color:var(--lime);text-shadow:0 0 12px rgba(57,255,106,.4)}.metric-value.bad{color:var(--red);text-shadow:0 0 12px rgba(255,77,94,.4)}.metric-note{display:block;color:var(--muted);font-size:11px;margin-top:2px}
